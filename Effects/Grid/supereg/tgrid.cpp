...
// int contador=0;
 ...
 cpx = 0; ///posicion relativa dentro de la grilla en x
 cpy = 0; ///posicion relativa dentro de la grilla en y
 ...
 //CAM->Oz = zz;
  float radioc2 = Mapa->radioc;
  float radioTorus = Mapa->radioc;
 ...
 MRSQ = radioc2 * radioc2 ;

 alfaang = acos( radioc2 / ( radioc2 + CAM->Oz ) );

 distmaxima = sqrt((CAM->Oz+10000000 + radioc2)*(CAM->Oz+10000000+radioc2) - MRSQ);
 //distmaxima = 10000000*1000000;

 dd =(radioc2/( radioc2 + CAM->Oz))*distmaxima;
...
TGrid::Animacion( TGrid *Inicial, TMapa *Mapa )
{
 ...
 int altsum=0;
  ...
  //MODebug2->Message( "m_height_multiply: " + FloatToStr( m_GridDefinition.m_height_multiply ) );
 ...
 for(j=0;j<dvspp;j++)
 {
  ...
  altitud =(G[j][i].alt-altsum) * m_GridDefinition.m_height_multiply;
...
TGrid::ProyectarTodo(TGrid *Inicial,TMapa *Mapa,float zz,TCAMARA3D *CAM)
{
 ...
 for(j=jstart;j<jend;j++)
 {
  ...
  ///Calcula la posicion del vertice en relacion al observador...
  ///
  px_i =(rad*(2*i-dvs)) + cpx_in_x;
  py_i =(-rad*(2*j-dvs)) + cpy_in_y;
  px =(float) px_i;
  ...
  if(pr<MRSQ)
  {
     ...
     pz = m_GridDefinition.m_planet_factor*pz + altitud;
...
TGrid::glProyectarTodo(TGrid *Inicial,TMapa *Mapa,float zz,TCAMARA3D *CAM)
{
 ...
 for(j=jstart;j<jend;j++)
 {
  ...
  if(pr<MRSQ)
  {
    ...
    //tx = m_GridDefinition.m_torus_factor*( Mapa->radiust - (Mapa->radiust-altitud)*sin(tr) );
    tx = m_GridDefinition.m_torus_factor* Mapa->radiust * sin( tr );
    px = px*( Mapa->factorradiopradioc )*(1.0-m_GridDefinition.m_torus_factor)
        + tx;
    ...
    //tz = m_GridDefinition.m_torus_factor*( Mapa->radiust - ( Mapa->radiust - altitud )*cos(tr) );
    //tz = 5*fabs(tx*tx/(Mapa->radiust));
    //tz = fabs( tx * sin( 0.5f*tr ));
    tz = m_GridDefinition.m_torus_factor * Mapa->radiust * ( 1.0f - cos( tr ));
    pz = (m_GridDefinition.m_planet_factor*pz+ altitud)*(1.0f-m_GridDefinition.m_torus_factor)
        + tz;
...
TGrid::glProyectarBorde(TGrid *Inicial,TMapa *Mapa,float zz,TCAMARA3D *CAM)
{
 ...
 if(i<=brdax+1 || i>=brdbx-1 || brdby-1<=j || j<=brday+1 || Padre==NULL)
 {
  ...
  //
  tr = ( MO_PI * px ) / Mapa->radiust;
  ///float crtr = sqrt( (1-cos(tr)*(1-cos(tr)+sin(tr)*sin(tr) );
  ...
  for( k = 0,kaux = inday,incremento_k = 1; k < kmax ; k++,kaux+=incremento_k)
   {
       ...
       if(L_PROY[jutil][iutil].SeDibuja==1 &&
          ...
          */
          ...
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE4, v1.u*16.0f, v1.v*16.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE5, v1.u*32.0f, v1.v*32.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE6, v1.u*64.0f, v1.v*64.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE7, v1.u*128.0f, v1.v*128.0f);
          //if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE1, 0.0f, 0.0f);
          ...
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE4, v2.u*16.0f, v2.v*16.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE5, v2.u*32.0f, v2.v*32.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE6, v2.u*64.0f, v2.v*64.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE7, v2.u*128.0f, v2.v*128.0f);
          ...
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE4, v3.u*16.0f, v3.v*16.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE5, v3.u*32.0f, v3.v*32.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE6, v3.u*64.0f, v3.v*64.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE7, v3.u*128.0f, v3.v*128.0f);

          //if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE1, 0.0f, 1.0f);
          ...
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE4, v4.u*16.0f, v4.v*16.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE5, v4.u*32.0f, v4.v*32.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE6, v4.u*64.0f, v4.v*64.0f);
          if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE7, v4.u*128.0f, v4.v*128.0f);

          //if (glMultiTexCoord2f) glMultiTexCoord2f(GL_TEXTURE1, 1.0f, 1.0f);
